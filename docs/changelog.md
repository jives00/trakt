...
- Replace simple watched toggle with action sheet matching web dropdown: date options (today, release/air date, pick date), add another watch entry, remove latest, remove all `b08bacc`
...
- Add Disconnect button to Trakt Connection card on Settings → Integrations `a5b977b`
...
### Web
- Fix ListArt crash when creating a new list (`previewBackdrops` undefined); increase list description to `text-sm` / `line-clamp-3` `054b200`
