  ...
  return (
    <ScrollView style={s.root} contentContainerStyle={s.content} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={handleRefresh} tintColor="#e8002d" colors={["#e8002d"]} />}>
      ...
      <View style={s.heroContent}>
        ...
        {show.overview ? (
          <Text style={s.heroOverview}>{show.overview}</Text>
        ) : null}
      </View>
      ...
      <View style={s.actionRow}>
        ...
        >
          <Ionicons name="ban-outline" size={18} color={status.inDropped ? "#fff" : "#f0f0f6"} />
        ...
        >
          <Ionicons name={status.inRewatch ? "repeat" : "repeat-outline"} size={18} color={status.inRewatch ? "#fff" : "#f0f0f6"} />
