...
const s = StyleSheet.create({
  ...
  upNextCard: { flexDirection: "row", marginHorizontal: 16, backgroundColor: "#1a1c1c", borderRadius: 8, overflow: "hidden" },
  ...
  upNextTitle: { fontSize: 13, fontWeight: "600", color: "#e2e2e2" },
  upNextMeta: { fontSize: 10, color: "rgba(226,226,226,0.4)", marginTop: 4 },
  ...
  seasonPoster: { width: SEASON_W, height: SEASON_W * 1.5, borderRadius: 6, backgroundColor: "#282a2b" },
  posterFallback: { backgroundColor: "#282a2b" },
  seasonLabel: { fontSize: 11, color: "#cccccc", marginTop: 5 },
  seasonMeta: { fontSize: 10, color: "#888", marginTop: 1 },

  castPhoto: { width: CAST_W, height: CAST_W * 1.5, borderRadius: 6, backgroundColor: "#282a2b" },
